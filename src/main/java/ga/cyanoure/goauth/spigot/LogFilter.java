...
public class LogFilter implements Filter {
	...
	public Filter.Result checkMessage(String msg) {
        if (msg.toLowerCase().contains("/l ") || msg.toLowerCase().contains("/login ") || msg.toLowerCase().contains("/register ") || msg.toLowerCase().contains("/reg ")
        		|| msg.toLowerCase().contains("/2fa ") || msg.toLowerCase().contains("/twofa ") || msg.toLowerCase().contains("/twofactor ")
        		|| msg.toLowerCase().contains("/changepassword ") || msg.toLowerCase().contains("/changepass ") || msg.toLowerCase().contains("/chpass ")
        		|| msg.toLowerCase().contains("/chpwd ") || msg.toLowerCase().contains("/chpasswd ") || msg.toLowerCase().contains("/chpassword ")
        		|| msg.toLowerCase().contains("/chpw ")) {
